  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <div className='font-35 text-white me-2'><i className={` bx  ${type==='error'?'bxs-message-square-x': 'bxs-check-circle'}`}></i></div>
          <div
            {...this.props.in && { role: role }}
            className={cx('Toastify__toast-body me-3', bodyClassName)}
          >
            <h6 className='mb-0 font-16 text-capitalize fw-bold text-light'>{type}</h6>
            {children}
          </div>
